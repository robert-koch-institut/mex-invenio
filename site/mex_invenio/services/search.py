...
class MexDumper(SearchDumper):
    ...
    def _resource_variables_groups(self, record, dump_data, log):
        ...
        if len(enGroups) > 0:
            dump_data["display_data"]["enVariableGroups"] = enGroups
            log.append("Resource Variables Groups EN:" + str(enGroups))

        if len(deGroups) > 0:
            dump_data["display_data"]["deVariableGroups"] = deGroups
    ...
    def _belongs_to(self, record, dump_data, log):
        ...
        if len(belongs_to_labels) > 0:
            dump_data["display_data"]["belongsToLabel"] = belongs_to_labels
    ...
    def _contributors(self, record, dump_data, log):
        ...
        dump_data["display_data"]["contributors"] = contributors
    ...
    def _creators(self, record, dump_data, log):
        ...
        dump_data["display_data"]["creators"] = creators
    ...
    def _external_partners(self, record, dump_data, log):
        ...
        dump_data["display_data"]["externalPartners"] = external_partners
    ...
    def _external_associates(self, record, dump_data, log):
        ...
        dump_data["display_data"]["externalAssociates"] = external_associates
    ...
    def _funder_commissioner(self, record, dump_data, log):
        ...
        if len(funder_commissioners_de) > 0:
            dump_data["display_data"]["deFunderOrCommissioners"] = funder_commissioners_de

        if len(funder_commissioners_en) > 0:
            dump_data["display_data"]["enFunderOrCommissioners"] = funder_commissioners_en
    ...
    def _involved_persons(self, record, dump_data, log):
        ...
        dump_data["display_data"]["involvedPersons"] = involved_persons
    ...
    def _used_in(self, record, dump_data, log):
        ...
        if len(used_in_en) > 0:
            dump_data["display_data"]["enUsedInResource"] = used_in_en

        if len(used_in_de) > 0:
            dump_data["display_data"]["deUsedInResource"] = used_in_de
