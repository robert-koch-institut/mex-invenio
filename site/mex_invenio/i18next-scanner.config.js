...
module.exports = {
  options: {
    ...
    resource: {
      ...
      loadPath: "assets/semantic-ui/js/mex_invenio/locales/{{lng}}/{{ns}}.json",

      // The path to store resources.
      savePath: "assets/semantic-ui/js/mex_invenio/locales/{{lng}}/{{ns}}.json",
      jsonIndent: 4,
      lineEnding: "\n",
    },
